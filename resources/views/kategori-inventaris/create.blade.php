...
@section('page-title','Tambah Kategori Inventaris')
@section('content')
<div class="row justify-content-center"><div class="col-lg-7">
    <nav aria-label="breadcrumb" class="mb-3"><ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="{{ route('kategori-inventaris.index') }}" class="text-decoration-none text-primary">Kategori Inventaris</a></li><li class="breadcrumb-item active">Tambah</li></ol></nav>
    <div class="card"><div class="card-header"><h6 class="mb-0 fw-bold">Form Tambah Kategori Inventaris</h6></div>
    <div class="card-body p-4">
        <form action="{{ route('kategori-inventaris.store') }}" method="POST" novalidate>
            @csrf
            <div class="row g-3">
                <div class="col-sm-6">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('kategori-inventaris.index') }}" class="btn btn-outline-secondary px-4">Batal</a>
